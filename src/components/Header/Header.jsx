  ...
  return (
    <header className={'header'}>
      <div className="header__inner">
        <a className={'header__logo'} title={'Go to home'} href="">
          <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
               width="50" height="50" viewBox="0 0 512.000000 512.000000" preserveAspectRatio="xMidYMid meet">
...
274 -299 282 -40 17 -89 17 -128 0z"/>
        ...
        <ul className="header__menu">
          ...
          <li className="header__menu-item">
            <a className={'header__menu-link'} href="#skills">Skills</a>
          </li>
          <li className="header__menu-item">
            <a className={'header__menu-link'} href="#portfolio">Portfolio</a>
          </li>
          <li className="header__menu-item">
            <a className={'header__menu-link'} href="#work-experience">Work Experience</a>
          </li>
          <li className="header__menu-item">
            <a className={'header__menu-link'} href="#contacts">Contacts</a>
          </li>
        </ul>
